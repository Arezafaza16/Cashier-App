...
const OrderDetail = () => {
    ...
    return (
        <div className=' p-10'>
            <IoChevronBackOutline onClick={() => navigate('/cashier/data-customers')} className=' m-5 font-bold text-4xl md:text-5xl bg-slate-50 hover:bg-slate-200 text-black border p-2 rounded-full' />
